...
Test_title=" Unit 12 Quiz [pattern B] "
Title_per_unit="**** Unit 12-{0} Quiz ****"

TOTAL_UNIT=4 #総合問題も含めたユニット数

ques_template="eng5_words_U12-{0}_question.txt"                  #問題文を保存するファイル
ans_template="eng5_words_U12-{0}_answer.txt"                     #問題の解答を保存するファイル
wrong_template="eng5_words_U12-{0}_wrong_total.txt"              #間違えた問題数の累積を記録するファイル

result_file_name="eng5_words_U12_result.txt"                     #全てのテスト結果が保存されるファイル
current_result_file_name="eng5_words_U12_current_result.txt"     #問題を解いたそのときの結果
weak_file_name="eng5_words_U12_weak_point.txt"                   #☆の入ったテキストファイル
...
def compile_wrong_data():
    ...
    #wrong_template="eng5_words_U12-{0}_wrong_total.txt"
    #template="eng5_words_U12-{0}_wrong_total.txt"
...
#テスト結果保存用のファイルを開く
# fileobj_show = open('eng5_words_U12-5_wrong_total.txt', "r", encoding = "utf_8")
